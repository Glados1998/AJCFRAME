      ...
      *    READ MJBASE
           ...
           IF FS-VENTESAS = 0 AND FS-VENTESEU = 0 AND FS-STOCKS = 0
               ...
               DISPLAY " FICHIER ASIE "
               PERFORM READASFILE UNTIL WS-EOF-VENTESAS = 'Y'
               DISPLAY " FICHIER EUROPE "
      ...
      *          DISPLAY "FILE CHNGFILE OPENED"
           ...
           IF FS-VENTESAS NOT EQUAL ZERO THEN
               DISPLAY 'ERR CLOSE NPRODATA : ' FS-VENTESAS
               PERFORM ABEND-PROG
           END-IF.
           CLOSE VENTESEU.
           IF FS-VENTESEU NOT EQUAL ZERO THEN
               DISPLAY 'ERR CLOSE NPRODATA : ' FS-VENTESEU
               PERFORM ABEND-PROG
           END-IF.

           CLOSE STOCKS.
           IF FS-STOCKS NOT EQUAL ZERO THEN
               DISPLAY 'ERR CLOSE NPRODATA : ' FS-STOCKS
               PERFORM ABEND-PROG
           END-IF.
      ...
      * AJOUT DES VENTES EN BASE
            ...
            DISPLAY NCLIENTEU ';' NPRODUITEU ';' PRIXEU ';'
      ...
      * AUGMENTATION SOLDE CLIENT
            IF CONTINUEINSERT = 'Y'
                MOVE  ORDERS-S-NO TO IDCLIENTMAJSOLDE
                MOVE  ITEMS-PRICE TO SOLDECOMMANDE
                PERFORM MAJSOLDECLIENT
            END-IF
      * GESTION DU STOCK
      ...
      *    MODIF STOCKS APRES COMMANDE
           DISPLAY "STOCK : ID ;" STOCKPRODUITENCOURS "STCK"
           SUBTRACT QCPRODUITENCOURS  FROM STOCKPRODUITENCOURS

           MOVE IDPRODUITSTOCKS TO PRODUCTS-P-NO
           ...
           DISPLAY "STOCKRESTANT : " STOCKPRODUITENCOURS
