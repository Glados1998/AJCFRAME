      ...
      *     DISPLAY "Devises : " DEVISE ";TAUX " TAUX
       ...
       SQL-ADD.
            MOVE WS-ANO-STR TO ITEMS-P-NO
            MOVE DESCRIPTION TO ITEMS-DESCRIPTION-TEXT
            MOVE 30 TO ITEMS-DESCRIPTION-LEN
            MOVE PRICE TO ITEMS-PRICE
            MOVE STOCK TO ITEMS-STOCK
      *     DISPLAY "SQL-ADD EN COURS"
            ...
            END-EXEC
            DISPLAY "INSERTION"
            DISPLAY SQLCODE ';' ITEMS-P-NO ';' ITEMS-DESCRIPTION
              ...
              STRING 'REQUETE:INSERT INTO' DELIMITED BY SIZE,
                               'API3.PRODUCT.VALUE(' DELIMITED BY SIZE,
                                ...
                                ',',
                                ITEMS-DESCRIPTION DELIMITED BY SIZE,
                                ',',
                                PRICE-STR DELIMITED BY SIZE,
                                ',',
                                STOCK-STR DELIMITED BY SIZE,
