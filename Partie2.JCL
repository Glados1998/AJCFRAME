...
//SYSTSIN  DD  *
  DSN SYSTEM (DSN1)
  RUN PROGRAM(PROJET2) PLAN (PROJET2)
/*
//VTSAS DD DSN=API3.PROJET.VENTESAS.DATA,DISP=SHR
//VTEU DD DSN=API3.PROJET.VENTESEU.DATA,DISP=SHR
//STCKS  DD DSN=API3.PROJET.STOCKS.DATA,DISP=SHR
//REAPPRO  DD DSN=API3.PROJET.REAPPRO.DATA,DISP=SHR
