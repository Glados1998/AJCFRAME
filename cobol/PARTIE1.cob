      ...
      *****************************************************************
       ...
       77 PRICE                PIC 9(5)v99 USAGE COMP-3.
       77 STOCK                PIC 9(3)v9.

       77 PRICE-CONV           PIC 9(4).
       77 PRICE-EDIT           PIC X(4).
       77 CHNG                 PIC 9(5)v99  VALUE 1.
      ...
      *                  DISPLAY "PRIX: " PRICE
                         ...
                         DISPLAY "CHNG" CHNG "PRICE" PRICE
                         COMPUTE PRICE = PRICE * CHNG
                         DISPLAY "PRICEf" PRICE
                         IF PRICE > 999
                            MOVE PRICE TO PRICE-CONV
                            MOVE PRICE-CONV TO PRICE-EDIT
                            STRING 'ERROR :' DELIMITED BY SIZE,
                                   WS-ANO-STR DELIMITED BY SIZE,
                                   " , " DELIMITED BY SIZE,
                                   DESCRIPTION-STR DELIMITED BY SIZE,
                                   " PRIX: " DELIMITED BY SIZE,
                                   PRICE-EDIT DELIMITED BY SIZE,
                                   ' $' DELIMITED BY SIZE,
                                   ' > AU MAX GERE ' DELIMITED BY SIZE
                            INTO ERROR-LINE
                            END-STRING
                            WRITE ENR-ERRORLOG
                            MOVE 'N' TO INSERTOK
      ...
      *    MISE EN MINUSCULE (EXCEPTE PREMIERE LETTRE) DES NOMS
           ...
           MOVE FUNCTION LOWER-CASE(DESCRIPTION-STR) TO DESCRIPTION-STR.


           INSPECT DESCRIPTION-STR REPLACING
           ALL " a" BY " A"
           ALL " b" BY " B"
           ALL " c" BY " C"
           ALL " d" BY " D"
           ...
           INSPECT DESCRIPTION-STR(1:1) REPLACING
           FIRST "a" BY "A"
           FIRST "b" BY "B"
           FIRST "c" BY "C"
           FIRST "d" BY "D"
           ...
           MOVE DESCRIPTION-STR TO DESCRIPTION
